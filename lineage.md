...
<details class="lineage-family">
  <summary>
    ...
    <span class="lineage-preview">{% if family.offspring and family.offspring.size > 0 %}{% for animal in family.offspring %}{{ animal.id }}{% unless forloop.last %} · {% endunless %}{% endfor %}{% else %}{% if family.source %}{{ family.source }}{% endif %}{% if family.hatch_date %}{% if family.source %} · {% endif %}{{ family.hatch_date }}{% endif %}{% endif %}</span>
  </summary>
  <div class="lineage-family-body">
    ...
    {% if family.source or family.hatch_date %}<p class="lineage-note">{% if family.source %}{{ family.source }}{% endif %}{% if family.hatch_date %}{% if family.source %} · {% endif %}{{ family.hatch_date }}{% endif %}</p>{% endif %}
    {% if family.offspring and family.offspring.size > 0 %}<div class="lineage-offspring">
